...
sonatypeProfileName := "ai.tripl.arc-graph-pipeline-plugin"
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/tripl-ai/arc-graph-pipeline-plugin"),
    "scm:git@github.com:tripl-ai/arc-graph-pipeline-plugin.git"
  )
)
developers := List(
